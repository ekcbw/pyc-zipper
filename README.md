...
Additionally, this tool depends on the [pyobject](https://github.com/ekcbw/pyobject) library, particularly the `Code` class in the [pyobject.code](https://github.com/ekcbw/pyobject/blob/main/pyobject/code.py) submodule. The `Code` class is a mutable bytecode wrapper that spans multiple Python versions (currently supporting 3.4 to 3.14) and even other implementations including PyPy.  
