...
```
即可安装`pyc-zipper`。  
此外，本工具依赖于[pyobject](https://github.com/qfcy/pyobject)库，尤其是[pyobject.code](https://github.com/qfcy/pyobject/blob/main/pyobject/code.py)中的`Code`类。`Code`类是跨多个Python版本(目前支持3.4到3.14，以及PyPy等)的可变字节码封装。  
